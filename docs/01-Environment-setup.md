...
In order to run bochs, you are going to need a bochs configuration file ([bochsrc.txt](../src/bochsrc.txt)). Coincidentally, a sample one is included below!
...
### 1.5.3. [`update_image.sh`](../src/update_image.sh)
...
### 1.5.4. [`run_bochs.sh`](../src/run_bochs.sh)
